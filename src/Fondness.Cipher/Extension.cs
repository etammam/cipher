...
/// <summary>
/// Provides extension methods for encrypting and decrypting strings using AES encryption.
/// </summary>
public static class Extension
{
    ...
    public static string ToEncrypt(this string input, string encryptionKey = EncryptionKey)
    {
        ...
        using (var cs = new CryptoStream(ms, standard.CreateEncryptor(), CryptoStreamMode.Write))
        {
